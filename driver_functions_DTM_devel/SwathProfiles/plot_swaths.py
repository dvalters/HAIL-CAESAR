...
def plot_swath_profiles(distance, channel_elev, swathdistance, slope_med, slope_lower, slope_upper, slope_min, slope_max, s3_med, s3_lower, s3_upper, s3_min, s3_max,
    ...
    ax1 = plt.subplot(313)
    collection = collections.BrokenBarHCollection.span_where(distance, ymin=0, ymax=1000, where=distance>=970, facecolor='0.8', edgecolor='0.8',alpha=0.5)
    ...
    ax1.annotate('Major knickpoint', xy=(975, 632),  xycoords='data',
    ...
    collection2 = collections.BrokenBarHCollection.span_where(swathdistance, ymin=0, ymax=1000, where=swathdistance>=970, facecolor='0.8', edgecolor='0.8',alpha=0.5)
    ...
    collection3 = collections.BrokenBarHCollection.span_where(swathdistance, ymin=0, ymax=1000, where=swathdistance>=970, facecolor='0.8',edgecolor='0.8', alpha=0.5)
...
#    inset_ax3.set_xscale('log')
    ...
    plt.savefig("K:/data/SurfaceRoughness/BaldRock/br_swath_long_profiles.pdf",format = OutputFigureFormat)
    plt.show()
    
if __name__ == "__main__":
    ChanFile = "K:/data/SurfaceRoughness/BaldRock/br_ChanNet_39_for_Arc.csv"    
    SlopeSwathFile = "K:/data/SurfaceRoughness/BaldRock/br_slope_long_profile.txt"
    s3SwathFile = "K:/data/SurfaceRoughness/BaldRock/br_s3_1_3_hillslope_only_long_profile.txt"
    SlopeHistFileAbove = "K:/data/SurfaceRoughness/BaldRock/br_slopeaboveKP.txt"
    SlopeHistFileBelow = "K:/data/SurfaceRoughness/BaldRock/br_slopebelowKP.txt"
    s3HistFileAbove = "K:/data/SurfaceRoughness/BaldRock/br_s3_1_3_hillslope_onlyaboveKP.txt"
    s3HistFileBelow = "K:/data/SurfaceRoughness/BaldRock/br_s3_1_3_hillslope_onlybelowKP.txt"
