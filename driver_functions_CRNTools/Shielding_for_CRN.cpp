//=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
//
// Shielding_for_CRN.cpp
// A program to calculate topographic shielding for a large number of basins
//
// Developed by:
...
int main (int nNumberofArgs,char *argv[])
{
  ...
  if (nNumberofArgs!=3)
  {
    ...
    cout << "|| This program is used to calculate shielding rasters ||" << endl;
    ...
    cout << "In linux:" << endl;
    cout << "./Shielding_for_CRN.exe home/fieldwork/Chile/CRN/ My_data" << endl;
    cout << "In windows (the slash directions will change and there is no leading ./)" << endl;
    cout << "Shielding_for_CRN.exe c:\\fieldwork\\Chile\\CRN\\ My_data" << endl;
    cout << "=========================================================" << endl;
